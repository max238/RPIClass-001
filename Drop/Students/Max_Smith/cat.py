...
# tells our mouse to go forward
def up():
     mouse.forward(10)
     checkbound()


# tells our mouse to go backwards
def back():
    mouse.backward(10)
    checkbound()

# tells our mouse to turn left
def left():
    mouse.left(45)


# tells our mouse to turn right
def right():
    mouse.right(45)
...
difficulty = window.numinput("Diffuculty", "Enter a difficulty from easy (1), for hard (5) ", minval=1, maxval=5)
